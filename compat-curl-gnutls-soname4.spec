...
Source0  : https://github.com/curl/curl/releases/download/curl-7_79_1/curl-7.79.1.tar.xz
Source1  : https://github.com/curl/curl/releases/download/curl-7_79_1/curl-7.79.1.tar.xz.asc
...
%prep
%setup -q -n curl-7.79.1
cd %{_builddir}/curl-7.79.1
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632334599
...
cp %{_builddir}/curl-7.79.1/COPYING %{buildroot}/usr/share/package-licenses/compat-curl-gnutls-soname4/73bcd04aed1c45b611fd34aaa29e72069a49049b
pushd ../build32/
%make_install32
